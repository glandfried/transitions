...
\end{equation}
%
\en{This allows us to partially define a graphical model with a causal interpretation, in which the environment is an independent random variable and strategy selection depends on the observed states of the environment. }%
\es{Esto nos permite definir parcialmente un modelo gráfico con una interpretación causal, en el que el ambiente es una variable aleatoria independiete y las selección de estrategias depende de los estados observados del ambiente. }%
%
\begin{figure}[H]
\centering
\tikz{
