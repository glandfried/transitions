...
%
\en{Even with this set of minimal assumptions, we obtain as a result of probabilistic inference an advantage in favor of cooperation and specialization. }%
\es{Incuso con este conjunto de supuestos mínimos, obtenemos como resultado de la inferencia probabilísitica una ventaja a favor de la cooperación y la especialización. } 
%
