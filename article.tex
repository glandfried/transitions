...
%
\en{However, they fail to implement any multilevel selection through Bayesian models. }%
\es{Sin embargo, no logran implementar ninguna selección multinivel a través de modelos bayesianos. }%
...
%
\en{This causal model does not presuppose any particular process for updating resources, so we are generalizing the problem. }%
\es{Este modelo causal no presupone ningún proceso de actualización de los recursos, por lo que estamos generalizando el problema. }%
%
\en{However, we show that inference is proportional to the resources obtained through a multiplicative process, supporting the isomorphism hypothesis between evolutionary and probabilistic theory. }%
\es{Sin embargo mostramos que el resultado de la inferencia es proporcional a los recursos obtenidos a través de un proceso multiplicativo, apoyando la hipótesis del isomorfimos entre la teoría de la evolutivas y probabilisticas. }%
%
...
%
\en{Using the rules of probability, we show that cooperative individuals, without being evolutionarily stable within groups, are favored by multilevel selection. }%
\es{Haciendo uso de las reglas de la probabilidad, mostramos que los individuos cooperadoras, sin ser evolutivamente estables al interior de los grupos, se ven favorecidas mediante selección multinivel. }%
%
\en{Finally, we show that, as soon as cooperation emerges an advantage in favor of the specialist strategies appears. }%
\es{Por último mostramos que, apenas surge la cooperación, aparece una ventaja a favor de las estrategias especialistas. }%

% Parrafo

\en{The advantage of cooperation and specialization is driven by the multiplicative (non-ergodic) nature of evolutionary and probabilistic theories, so this must be considered the first cause of major evolutionary transitions. }%
\es{La ventaja de la cooperación y de la especialización está impulsada por la naturaleza multiplicativa (no-ergódica) de las teorías evolutivas y probabilísticas, por lo que ésta debe ser considerada la primera causa de las transiciones evolutivas mayores. }
\end{abstract}
...
%
\en{Under this minimal set of hypotheses, where we co-consider \emph{unconditionally} cooperative individuals who generate a common good that can be exploited by defecting individuals without receiving some kind of punishment in return (e.g. end of cooperation), the evolution of cooperation literature predicts defection as the only evolutionarily stable strategy. }%
\es{Bajo este conjunto mínimo de hipótesis, donde cosideramos individuos \emph{incondicionalmente} cooperadores que generan un bien común que puede ser explotado por individuos desertores sin que reciban a cambio algún tipo de castigo (e.g fin de la cooperación), la literatura de evolución de la cooperación predice que la deserción es la única estrategia evolutivamente estable. }%
%
...
%
\en{}%
\es{En las ciencias sociales se supone que existe }%


\en{}%
\es{Desde el surgimiento }%
%
...
%
\en{However, the result of the probabilistic inference reveals an advantage in favor of cooperation (and specialization). }%
\es{Sin embargo, el resultado de la inferencia probabilísitica revela una ventaja a favor de la cooperación (y la especialización). } 
%
...
\en{}
\es{La literatura de evolución de la cooperación en general }

\en{The reason why an advantage in favor of cooperation and specialization arises in such a simple causal model is due to the multiplicative (non-ergodic) nature of probabilistic theory and its isomorphism with evolutionary theory. }%
\es{El motivo por el cual surge una ventaja a favor de la cooperación y la especialización en un modelo causal tan simple se debe a la naturaleza multiplicativa (no-ergódica) de la teoría de la probabililidad y a su isomorfismo con la teoría de la evolución. }
%
\en{As a consequence of the non-ergodicity of multiplicative processes, fluctuations have a negative effect on individual growth rates, which can be reduced through mutual cooperation, leading to an increase in the long-term growth rates of all individuals. }%
\es{Como consecuencia de la no-ergodicidad de los procesos multiplicativos, las fluctuaciones tienen un efecto negativo en las tasas de crecimiento individuales, las cuales pueden ser reducidas a través de la mutua cooperación, produciendo un aumento de la tasas de crecimiento a largo plazo de todos los individuos. }%
%
Y como consecuencia de la ergodicidad adquirida a través de la cooperación, los individuos pueden adquirir comportamientos con fluctuaciones individuales pero con mejores retornos, generando una ventaja a favor de las estrategias especialistas.

\en{Then, as soon as cooperation emerges an advantage in favor of the specialist strategies also appears. }%
\es{Luego, apenas surge la cooperación, aparece una ventaja a favor de las estrategias especialistas. }%




Una hpor lo que ésta debe ser considerada la primera causa de las transiciones evolutivas mayores
...
When a group consist of $N = N_{crit}$ individuals, every and 
each one of these individuals cannot afford to defect since
then the rest of the population will decay and even if the
others would keep sharing with him/her, the entire system
will eventually collapse, including the defector. One could
argue that this argument holds only in cases where N =
N crit and when N > N crit one can still decide to defect
and do better than the rest. Our answer to this argument
may sound similar to group selection arguments but with a
slight change: we have showed that the asymptotic growth
rate is an increasing function of N . Hence, on average, each
of the individuals in a group with N individuals with one
defector will have the effective growth rate of individuals
in a group with N − 1 individuals. In principal, if this
rate is still positive, one may be tempted to defect, but in
practice, if this group is part of a larger population, each
of the individuals will do worse (on average) than other
individuals from other groups with N sharing individuals.
\end{quotation}
...
\en{This causal model does not presupose any particular process for updating resources, so we are generalizing the problem. }%
\es{Este modelo causal no presupone ningún proceso de actualización de los recursos, por lo que estamos generalizando el problema. }%
%
\en{However, we show that inference is proportional to the resources obtained through a multiplicative process, supporting the isomorphism hypothesis between evolutionary and probabilistic theory. }%
\es{Sin embargo mostramos que el resultado de la inferencia es proporcional a los recursos obtenidos a través de un proceso multiplicativo, apoyando la hipótesis del isomorfimos entre la teoría de la evolutivas y probabilisticas. }%
