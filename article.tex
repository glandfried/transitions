...
%opening
\title{Multilevel selection in causal models: the non-ergodicity of evolutionary and probability theories as the general driver of the emergence of cooperation and specialization. }
