...
\en{The isomorphism between the fundamental equations of the evolutionary theory (replicator dynamic) and the probability theory (Bayes theorem) is immediate when we identify that the probability distribution of the hypotheses is the distribution of the strategies, and the fitness is the likelihood~\cite{shalizi2009-replicatorAsInference,harper2009-replicatorAsInference}, }%
...
\centering
 \begin{tabular}{l|l}
  ...
  Prior $p(H)$ & \en{Distribution of strategies}\es{Distribución de estrategias}$x_e$ \\ \hline
  Verosimilitud $p(D|H)$ & Fitness $f_e(a)$ \\ \hline
  Posterior $p(H|D)$ & Proproción posterior $x_e^\prime$ \\ \hline
  Evidencia $p(D)$ & Population mean fitness $\sum x_e f_e(a) $ \\ \hline
 \end{tabular}
\end{align*}
%
