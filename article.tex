...
%
\begin{equation}
\lim_{N \rightarrow \infty} g_C^n(k|\Ee,p,N) \propto \Big( p \Ee + (1-p)(1-\Ee) \Big)  \frac{n}{N}
\end{equation}
%
...
%
\en{In figure \ref{fig:multilevel-selection-7} we show the proprotional of the growth rate as a function of the proportion of total defectors in a group of size $1000$. }%
\es{En la figura \ref{fig:multilevel-selection-7} mostramos el proporcional de la tasa de crecimiento en función de la proproción de desertores totales en una grupo de tamaño $1000$. }%
%
\en{In Figure~\ref{fig:multilevel-selection-5} we rescale the proportional growth rate by a factor $2.1$, and we see that it overlaps over the resource trajectories presented in Figure~\ref{fig:ergodicity_desertion}. }
...
\begin{equation*}
\begin{split}
g_{[\cdot]}^n(k|\Ee=0.71, \, p=0.5, \, N=2)  \ \ \ \ & \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ g_{[\cdot]}^n(k|\Ee=0.71, \, p=0.5, \, N=16)  \\[0.1cm] \hline
\bordermatrix{ & n=0 & n=1 \cr
      C & 0.475 & 0.226 \cr
      D & 0.452 &  0.452 }\ \ \ \ \ \ \ \ \ \ \ \ \  &  \ \ \ \ \ \ \ \ \ \ \ \ \  \bordermatrix{ & n=0 & n=1 & n=2 & n=3 \cr
