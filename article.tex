...
%opening
\title{\vspace{-2.2cm}Multilevel selection in causal models: the non-ergodicity of evolutionary and probability theories as the general driver for the emergence of cooperation and specialization.\footnote{\url{https://github.com/glandfried/transitions/releases/download/doc.0.0.0/landfried-trans\en{itions}\es{iciones}.pdf} } }
...
\es{Es decir, en contra de la creencia establecida que se tiene en economía desde mediados del siglo 20, mostramos que los dinámicas de bienes comunes no puede representarse mediante una matriz de pagos del dilema del prisionero. }%
%
