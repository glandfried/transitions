...
\end{figure}
%
Si bien este modelo es válido, en tanto la descomposición$P(e,I,C^1,C^2)= P(e|I,C^1,C^2)P(I|C^1,C^2)P(C^1|C^2)P(C^2)$ vale por la regla del producto, el modelo no fue desarrollado con una interpretación causal.
%
...
%
Y a la invversa, todas las colectividades e individuos aparecen independientes del ambiente.
%
...
Veamos qué ocurre cuando intentamos traducir el modelo propuesto por Ole Peters en un modelo de estas caracterísiticas.
